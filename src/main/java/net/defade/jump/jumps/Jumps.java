...
public enum Jumps {
    ...
    BALLOONS(Difficulties.EASY, text("Bal").color(color(NamedTextColor.YELLOW)).append(text("loo").color(color(NamedTextColor.WHITE))
            ...
            5, 5, 50000,
            List.of(new Pos(108, 5, -1), new Pos(107, 5, -1), new Pos(106, 5, -1)), new Pos(123, 132, -82), 180),
    ...
    STRONGOLD(Difficulties.EASY, text("Str").color(color(90, 90, 90)).append(text("ong").color(color(130, 130, 130))).append(text("old").color(color(160, 160, 160))),
            5, 5, 23000,
            List.of(new Pos(110, 5, 167), new Pos(110, 5, 166), new Pos(110, 5, 165)), new Pos(167, 117, 177), -90),

    JUNGLE_TREES(Difficulties.EASY, text("Jungle").color(color(30, 161, 27)).append(text(" Trees").color(color(77, 237, 74))),
            5, 5, 20000,
            List.of(new Pos(104, 5, 167), new Pos(104, 5, 166), new Pos(104, 5, 165)), new Pos(66, 121, 170), 90),

    NETHER_FIELDS(Difficulties.EASY, text("Nether").color(color(255, 36, 36)).append(text(" Fields").color(color(201, 14, 14))),
            5, 5, 33000,
            List.of(new Pos(110, 5, 189), new Pos(110, 5, 188), new Pos(110, 5, 187)), new Pos(164, 125, 202), -90),
    ...
    OVERGROWNED_DEEPSLATE(Difficulties.EASY, text("Overgrowned").color(color(70, 171, 70)).append(text(" Deepslate").color(color(44, 145, 69))),
            5, 5, 19000,
            List.of(new Pos(104, 5, 189), new Pos(104, 5, 188), new Pos(104, 5, 187)), new Pos(88, 118, 198), 90),

    LUSH(Difficulties.EASY, text("Lu").color(color(39, 232, 71)).append(text("sh").color(color(39, 232, 110))),
            5, 5, 20000,
            List.of(new Pos(110, 5, 211), new Pos(110, 5, 210), new Pos(110, 5, 209)), new Pos(116, 5, 203), -90),

    WINDY_AZALEA(Difficulties.EASY, text("Windy").color(color(37, 207, 71)).append(text(" Azalea").color(color(68, 232, 39))),
            5, 5, 21000,
            List.of(new Pos(104, 5, 211), new Pos(104, 5, 210), new Pos(104, 5, 209)), new Pos(48, 121, 214), 90),

    WET_TAIGA(Difficulties.EASY, text("Wet").color(color(60, 127, 186)).append(text(" Taiga").color(color(60, 186, 115))),
            5, 5, 33000,
            List.of(new Pos(110, 5, 233), new Pos(110, 5, 232), new Pos(110, 5, 231)), new Pos(136, 118, 238), -90),

    MESA(Difficulties.EASY, text("Mesa").color(color(219, 124, 35)),
            5, 5, 21000,
            List.of(new Pos(104, 5, 233), new Pos(104, 5, 232), new Pos(104, 5, 231)), new Pos(90, 131, 230), 90),
    ...
    private final List<Pos> startPlates;
    private final Pos finishPlate;
    private final float startYaw;

    Jumps(Difficulties difficulty, Component name, double crystalReward, double endermiteReward, int timeForReward, List<Pos> startPlates, Pos finishPlate, float startYaw) {
    ...
    public List<Pos> getStartPlates() {
        return startPlates;
    }
